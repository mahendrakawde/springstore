/* Copyright 2004 Sun Microsystems, Inc.  All rights reserved.  You may not modify, use, reproduce, or distribute this software except in compliance with the terms of the License at: 
 ...
 $Id: AirlinePOEndpointBean.java,v 1.8 2004/07/30 23:59:19 inder Exp $ */
...
public class AirlinePOEndpointBean implements SessionBean {
     ...
     * for the order
     */
    public String submitAirlineReservationDetails(String xmlPO)
  ...
  return("FLIGHT1234");
    ...
    private AirlineOrder preProcessInput(String po)
  ...
  return(AirlineOrder.fromXML(po));
    ...
    private void submitRequest(AirlineOrder flight)
  ...
  try {
    ...
    sl.getJMSConnectionFactory(JNDINames.AIRLINE_QUEUECONNECTIONFACTORY);
