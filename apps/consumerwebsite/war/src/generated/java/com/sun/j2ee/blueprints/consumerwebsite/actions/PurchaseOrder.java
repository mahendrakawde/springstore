...
public class PurchaseOrder {
	...
	public PurchaseOrder(
			com.sun.j2ee.blueprints.consumerwebsite.actions.Activity[] activities,
			com.sun.j2ee.blueprints.consumerwebsite.actions.ContactInfo billingInfo,
			com.sun.j2ee.blueprints.consumerwebsite.actions.CreditCard creditCard,
			java.lang.String departureCity,
			com.sun.j2ee.blueprints.consumerwebsite.actions.Transportation departureFlightInfo,
			java.lang.String emailId,
			java.util.Calendar endDate,
			int headCount,
			java.lang.String locale,
			com.sun.j2ee.blueprints.consumerwebsite.actions.Lodging lodging,
			java.util.Calendar orderDate,
			java.lang.String poId,
			com.sun.j2ee.blueprints.consumerwebsite.actions.Transportation returnFlightInfo,
			com.sun.j2ee.blueprints.consumerwebsite.actions.ContactInfo shippingInfo,
			java.util.Calendar startDate, float totalPrice,
	...
	public void setDepartureFlightInfo(
			com.sun.j2ee.blueprints.consumerwebsite.actions.Transportation departureFlightInfo) {
		this.departureFlightInfo = departureFlightInfo;
	}
	...
	public void setReturnFlightInfo(
			com.sun.j2ee.blueprints.consumerwebsite.actions.Transportation returnFlightInfo) {
		this.returnFlightInfo = returnFlightInfo;
	}
