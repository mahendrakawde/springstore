...
public class MockDelegatingOrderService implements PurchaseOrderService,
		OrderTrackingService {

	@Override
	public String submitPurchaseOrder(PurchaseOrder po)
			throws ProcessingException, InvalidPOException {
		PurchaseOrderService delegate = MockHolder
				.getMock(PurchaseOrderService.class);
	...
	public OrderDetails getOrderDetails(String orderId)
		...
		OrderTrackingService delegate = MockHolder
				.getMock(OrderTrackingService.class);
