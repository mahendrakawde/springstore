...
public class TransportationBean extends Transportation implements Serializable {
	...
	public TransportationBean(String transportationId, String name,
	...
	public String toString() {
		return "Transportation[id=" + getTransportationId() + ", name="
				+ getName() + ", price=" + getPrice() + ", description="
				+ getDescription() + ", origin=" + getOrigin()
				+ ", destination=" + getDestination() + ", carrier="
				+ getCarrier() + ", departure time=" + getDepartureTime()
				+ ", arrival time =" + getArrivalTime() + ", travel class ="
				+ getTravelClass() + "]";
	}
