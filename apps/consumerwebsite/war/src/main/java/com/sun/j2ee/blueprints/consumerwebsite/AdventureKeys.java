 ...
 */
public final class AdventureKeys extends WebKeys {

	private AdventureKeys() {
	...
	// internal keys
	public static final String PO_SERVICE = "java:comp/env/service/OpcPurchaseOrderService";
}
