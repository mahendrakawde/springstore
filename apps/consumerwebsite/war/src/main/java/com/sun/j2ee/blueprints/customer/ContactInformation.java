...
/**
 * This class represents all the data needed to identify an indvidual and
 * contact that individual. This class is meant to be immutable.
 */
public class ContactInformation implements java.io.Serializable {
	...
	public ContactInformation(String familyName, String givenName,
