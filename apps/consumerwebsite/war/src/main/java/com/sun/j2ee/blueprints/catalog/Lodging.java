...
/**
 * This class represents a lodging in the Adventure Builder. It has attributes
...
public class Lodging implements Serializable {
	...
	public Lodging(String lodgingId, String name, String description,
	...
	public String toString() {
		return "Lodging [id=" + lodgingId + ", name=" + name + ", price="
