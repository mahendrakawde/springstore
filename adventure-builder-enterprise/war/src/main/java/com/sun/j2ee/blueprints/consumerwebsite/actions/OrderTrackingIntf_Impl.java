...
public class OrderTrackingIntf_Impl implements com.sun.j2ee.blueprints.consumerwebsite.actions.OrderTrackingIntf, java.rmi.Remote {
    public com.sun.j2ee.blueprints.consumerwebsite.actions.OrderDetails getOrderDetails(java.lang.String string_1) throws 
        ...
        com.sun.j2ee.blueprints.consumerwebsite.actions.OrderDetails _retVal = null;
        return _retVal;
    }
}
