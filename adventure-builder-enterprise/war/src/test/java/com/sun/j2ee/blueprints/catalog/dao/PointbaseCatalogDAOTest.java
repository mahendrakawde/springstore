...
public class PointbaseCatalogDAOTest extends AbstractDaoTests {
	...
	private PointbaseCatalogDAO dao = new PointbaseCatalogDAO();
	...
	protected void setupJndiContext() throws Exception {
		...
		builder.bind(JNDINames.CATALOG_DAO_CLASS, "com.sun.j2ee.blueprints.catalog.dao.PointbaseCatalogDAO");	
	}
