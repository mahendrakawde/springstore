...
public class DAOSystemException extends RuntimeException {
    ...
    public DAOSystemException() { super(); }
    public DAOSystemException(final String msg) { super(msg); }
    public DAOSystemException(final String msg, final Throwable cause) {
        super(msg, cause);
    }
    public DAOSystemException(final Throwable cause) {
        super(cause);
    }
}
